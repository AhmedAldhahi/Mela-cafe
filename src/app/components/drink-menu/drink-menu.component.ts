...
export class DrinkMenuComponent {
  drinksMenu = [
    {
      ...
      description: 'Fresh, full-bodied with aromas of ripe berries, spices, plum and vanilla.',
      category: 'Come',
    ...
    },
    {
      ...
      price: 'Glass: 119,- / Bottle: 550,-',
      description: 'Juicy, cool and soft with ripe berries, dried fruit, herbs and spices.',
      category: 'Come',
      subCategory: 'Red Wine',
      allergens: ['Sv']
    },
    ...
    },
    {
      ...
      description: 'Dark ruby color, aromas of vanilla and wood, round tannins, long finish.',
      category: 'Come',
      subCategory: 'Red Wine',
      allergens: ['Sv']
    },
    {
      ...
      price: 'Bottle: 1,119,-',
      description: 'Brick red, ripe, exotic and spicy with chocolate and leather notes.',
      category: 'Come',
      subCategory: 'Red Wine',
      allergens: ['Sv']
    },
    {
      ...
      price: 'Glass: 119,- / Bottle: 550,-',
      description: 'Fresh and fruity with tropical fruit, lime, melon, peach and apricot.',
      category: 'Come',
    ...
    },
    {
      ...
      price: 'Glass: 119,- / Bottle: 550,-',
      description: 'Citrus, apple, peach and mineral notes. Dry and juicy with good fruit length.',
      category: 'Come',
      subCategory: 'White Wine',
      allergens: ['Sv']
    },
    {
      ...
      price: 'Glass: 119,- / Bottle: 550,-',
      description: 'Fresh flavors of peach, passion fruit, herbs, lemon and lime.',
      category: 'Come',
      subCategory: 'White Wine',
      allergens: ['Sv']
    },
    ...
    },
    {
      ...
      description: 'Aromas of tropical fruit, melon, guava and lime. Fresh and fruity finish.',
      category: 'Come',
      subCategory: 'White Wine',
      allergens: ['Sv']
    },
    ...
    },
    {
      name: 'Glenfiddich',
      price: '129,-',
      description: 'Single malt Scotch whisky known for its fresh and fruity aroma.',
      category: 'Whisky',
      allergens: []
    },
    {
    ...
    },
    {
      ...
      price: '119,-',
      description: 'Smooth and elegant cognac with a balanced blend of fruit and oak.',
      category: 'Cognac',
      allergens: []
    },
    {
    ...
    },
    {
      name: 'Aquavit',
      price: '119,-',
      description: 'Traditional Scandinavian spirit with caraway and spice notes.',
      category: 'Other',
      allergens: []
    },
    {
    ...
    },
    {
      ...
      price: '119,-',
      description: 'American amber lager with a hoppy and caramel character. 5.2%',
      category: 'Beer/Misc',
      allergens: ['Mb']
    },
    {
  ...
  drinkCategories = ['Come', 'Whisky', 'Hetvin', 'Cognac', 'Other', 'Beer/Misc'];
  ...
  getDrinksBySubCategory(category: string, sub: string) {
    return this.drinksMenu.filter(item => item.category === category && item.subCategory === sub);
  }
